...
const NavLight = () => {
  ...
  const { cerrarSesion } = UsuarioStore.getState();
  const navigate = useNavigate();

  const handleLogout = () => {
    cerrarSesion(); // limpia Zustand + localStorage
    navigate("/login"); // Redirige a login para evitar regresar con botón atrás
  };
          ...
          <div>
            {usuario ? (
              <div className="btnIconosNavegacion">
                <i className="fa-solid fa-user"></i> Hola,{" "}
            ...
            <li className="has-megamenu">
              ...
              <div className="megamenu">
                <div className="column">
                  ...
                  <Link to="/p-fem">perfumeria femenina</Link>
                  <Link to="/p-hombre">perfumeria masculina</Link>
                  <Link to="/p-infantil">perfumeria infantil</Link>
                </div>
                <div className="column">
            ...
            <li className="has-megamenu">
              ...
              <div className="megamenu">
                ...
                <div className="column">
                  ...
                  <Link to="/para-el-rostro/polvo-compacto">
                    polvo compacto
                  </Link>
                  <Link to="/para-el-rostro/bruma-fijadora">
                    bruma fijadora
                  </Link>
                </div>
                <div className="column">
            ...
            <li className="has-megamenu">
              ...
              <div className="megamenu">
                ...
                <div className="column">
                  ...
                  <Link to="/hidratante/para manos y pie">
                    para manos y pie
                  </Link>
                </div>
              </div>
            ...
            <li className="has-megamenu">
              ...
              <div className="megamenu">
                <div className="column">
                  ...
                  <Link to="/tipo-de-cabello/cabello-dañado">
                    cabello dañado
                  </Link>
                  <Link to="/tipo-de-cabello/cabello-rizado">
                    cabello rizado
                  </Link>
                </div>
                <div className="column">
